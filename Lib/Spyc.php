...
if (!function_exists('spyc_load')) {
  ...
  function spyc_load ($string) {
    return Turbo_Lib_Spyc::YAMLLoadString($string);
  }
}
...
if (!function_exists('spyc_load_file')) {
  ...
  function spyc_load_file ($file) {
    return Turbo_Lib_Spyc::YAMLLoad($file);
  }
}
...
/**
   ...
   * or:
   * <code>
   *   $array = Turbo_Lib_Spyc::YAMLLoad($file);
   * </code>
   * or:
   * <code>
   *   $array = spyc_load_file($file);
   * </code>
   * @package Turbo_Lib_Spyc
   */
class Turbo_Lib_Spyc {
 ...
 */
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = Turbo_Lib_Spyc::YAMLLoad('lucky.yaml');
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = Turbo_Lib_Spyc::YAMLLoadString("---\n0: hello world\n");
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
