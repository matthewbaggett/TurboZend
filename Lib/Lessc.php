 ...
 *
 *  See the following:
 *    - entry point for parsing and compiling: Turbo_Lib_Lessc::parse()
 *    - parsing: Turbo_Lib_Lessc::parseChunk()
 *    - compiling: Turbo_Lib_Lessc::compileBlock()
 *
 */
class Turbo_Lib_Lessc {
	protected $buffer;
	protected $count;
	protected $line;
	 ...
	 *
	 * Consider the function Turbo_Lib_Lessc::keyword(). (all parse functions are
	 * structured the same)
	 *
	 ...
	 *
	 * All of these parse functions are powered by Turbo_Lib_Lessc::match(), which behaves
	 ...
	 * avoid this, Turbo_Lib_Lessc::seek() is used to remember and set buffer positions.
	 *
	 ...
	 *
	 * See Turbo_Lib_Lessc::compileProp()
	 *
	 */
	...
	protected function createChild($fname) {
		$less = new Turbo_Lib_Lessc($fname);
